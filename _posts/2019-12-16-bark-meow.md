...
There exist nice tutorials about learning CNNs (convolutional neural networks) 
that show how to solve rather simple tasks 
...
So I tried a simple task of classifying dog sounds and cat sounds - 
...
I hope further examination and research about end-to-end learning applied on audio signals reveal more
about the inner mechanisms and give more intuition.
